...
if (temperature >= 80 && rain) {
  ...
  console.log("One should wear a jacket and an umbrella");
...
console.log(`and now your score has been logged ${score} times`);
...
//CODE HERE
// let countdown = 1
// while loop that continues to run while z is greater than 0
while (z > 0) {
  // Within the while loop, log a countdown from the value of z to 1
  // z--
  // console.log(z)
  //how do I get it to stop at one?
  //how do I make it start from z?
